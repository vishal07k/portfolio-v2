...
// Custom inline SVG icons for brands to ensure cross-environment compatibility
    ...
    <footer className="footer">
      <div className="container footer-container">
        ...
        <nav className="footer-links">
          ...
          <a href="#hero" className="footer-link" onClick={(e) => { e.preventDefault(); scrollToTop(); }}>
            {t('footer.backToTop')}
          </a>
        </nav>
